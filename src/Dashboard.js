...
const cropData = [
  ...
  { name: 'Peppermint', Current: 280, 'Last 30 days': 320 },
  { name: 'Choysum', Current: 220, 'Last 30 days': 200 },
  { name: 'Kale', Current: 350, 'Last 30 days': 300 },
];
    ...
    <main className="dashboard-main">
      <section className="overview-header">
        ...
        <div className="filters">
          ...
          <button>Compare: Previous period <FiChevronDown /></button>
        </div>
      </section>

      <section className="stat-cards">
        <div className="stat-card">
          <span className="card-title">Total active plants</span>
          <div className="card-value">120</div>
          <div className="card-change positive"><FiArrowUp /> 5.8%</div>
        </div>
        <div className="stat-card">
          <span className="card-title">Harvest-ready</span>
          <div className="card-value">12</div>
          <div className="card-change neutral"></div>
        </div>
        <div className="stat-card">
          <span className="card-title">Total harvest</span>
      ...
      <section className="performance-charts">
        <div className="chart-card">
          <div className="chart-header">
            <h4>Harvest performance</h4>
            <span>Previous period</span>
          </div>
          <div className="chart-value">
            <div><span className="chart-label">Harvest volume</span><strong>200</strong></div>
        ...
        <div className="chart-card">
          ...
          <div className="chart-value">
            <div><span className="chart-label">Sales revenue</span><strong>$2200.54</strong></div>
      ...
      <section className="bottom-row">
        <div className="card capacity-card">
          ...
          <div className="capacity-list">
            ...
            <div className="capacity-item">
              ...
              <div className="item-progress">
                <div className="progress-bar">
                  <div style={{ width: '40%', backgroundColor: 'var(--orange-500)' }}></div>
                </div>
            ...
            <div className="capacity-item">
              ...
              <div className="item-progress">
                <div className="progress-bar">
                  <div style={{ width: '90%', backgroundColor: 'var(--green-500)' }}></div>
                </div>
        ...
        <div className="alerts-column">
          ...
          <div className="card alerts-card">
            ...
            <div className="alert-list">
              <div className="alert-item">
                <FiAlertCircle className="icon orange" />
